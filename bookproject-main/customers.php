                ...
                <div class="row">
                    <div class="collapse navbar-collapse " id="navbarNav">
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " style='border-bottom:solid 1px white;'
                                    href="customers.php">Customer
                                </a>
                            </li>
                            <li class="nav-item">
    ...
    <div>
        ...
        <form action="" method="GET">
            <div class=" container-fluid d-flex justify-content-evenly row ">
                ...
                <input name="firstname" class="form-control w-25 m-3" type="text" placeholder="First Name"
                    aria-label="default input example" required>
                <input name="last_name" class="form-control w-25 m-3" type="text" placeholder="Last Name"
                    aria-label="default input example" required>
                <input name="phone" class="form-control w-25 m-3" type="text" placeholder="Phone"
                    aria-label="default input example" required>
                <input name="email" class="form-control w-25 m-3" type="text" placeholder="Mail"
                    aria-label="default input example" required>
                <input name="address" class="form-control w-25 m-3" type="text" placeholder="Address"
                    aria-label="default input example" required>
                <input name="city" class="form-control w-25 m-3" type="text" placeholder="City"
                    aria-label="default input example" required>
                <input name="postal_code" class="form-control w-25 m-3" type="text" placeholder="Postal Code"
                    aria-label="default input example" required>
