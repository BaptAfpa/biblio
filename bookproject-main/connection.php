...
<body style="background-image:url(book.png);background-attachment: fixed;">
    ...
    <div class="container-fluid">
        <div
            class="row justify-content-md-center position-absolute top-50 start-50 translate-middle container text-center">
            <div class="card text-bg-dark mb-3 text-center" style="max-width: 18rem;">
                <?php if ($mauvais == 1) { ?>
                    <h1 style="color:red; font-size:50px;">Wrong username or password try again!</h1>
                <?php } ?>
